...
public class pullrequests_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterOpen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Open", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        filterCreatedByMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Created by me", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        filterVisibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Visibility", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        filterOrganization.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Organization", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        filterRepository.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Repository", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        filterSort.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Filter: Sort by Newest", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        resetFilters.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(pullrequests_activity.this, "Resetting Filters", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
